...
format: 
  ...
  html:
    ...
    href: qmd_example.pdf #I don't know why it doesn't work
editor: source
...
::: {#fig-horse-pop}
![](../results/horse_pops_plot.png){fig-cap="Horse populations for all provinces in Canada from 1906 - 1972."}
:::
...
::: {#fig-largest-sd}
![](../results/horse_pop_plot_largest_sd.png){fig-cap="Horse populations for the province with the largest standard deviation." width=65%}
:::
